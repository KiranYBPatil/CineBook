...
const Header = ({ showData, type }) => {
  ...
  return (
    <>
    <div className="border-b border-gray-200 dark:border-gray-700 shadow-sm bg-[var(--bg-primary)] transition-colors duration-200">
      {/* Top Bar */}
      <div className="flex items-center justify-between py-4 px-6">
...

        {
          type === "checkout" ? (
            <div>
              <h2 className="font-bold text-gray-900 dark:text-gray-100 text-lg md:text-xl">Review your booking</h2>
            </div>
          ) : (
    ...
    {
      type !== "checkout" &&(
         <div className="bg-[var(--bg-primary)] pt-4 transition-colors duration-200">
  <div className="mx-auto px-6 pb-4 flex items-center gap-4 max-w-7xl">
    ...
    {/* Show Time Button */}
    <button className="border cursor-pointer rounded-[14px] px-8 py-3 text-sm border-black dark:border-gray-400 font-medium bg-gray-200 dark:bg-gray-700 text-[var(--text-primary)] flex flex-col items-center">
...
<hr className="my-2 border-gray-300 dark:border-gray-700 max-w-7x1 mx-auto" />
